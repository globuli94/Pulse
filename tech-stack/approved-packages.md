...
**Owner:** CTO
**Consumers:** Flutter Developer, QA Agent, Firebase Engineer

This file is the single source of truth for all approved packages and technologies in the project. It is maintained by the CTO and updated only after board approval of a package proposal.
...
| Firebase core | Firebase Core | `firebase_core` | latest |
...
|---|---|---|
| 2026-05-24 | Initial package set defined for Pulse | Board (CEO) |

---

> Additional packages require a `PACKAGE PROPOSAL` comment on the relevant ticket, followed by board approval. The CTO updates this file once approved.
